                    ...
                    <div class="w-lg-500px p-10">
                        <form class="form w-100" action="{{ route('password.email') }}" method="POST">
                            ...
                            <div class="text-center mb-10">
                                <h1 class="text-gray-900 fw-bolder mb-3">{{ __('auth.forgot_password_heading') }}</h1>
                                <div class="text-gray-500 fw-semibold fs-6">{{ __('auth.forgot_password_description') }}</div>
                            </div>
                            <!--end::Heading-->
