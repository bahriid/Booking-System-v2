...
@section('title', __('emails.approved_title', ['code' => $booking->booking_code]))

@section('content')
<div class="email-header" style="background-color: #50cd89;">
    <h1>{{ __('emails.approved_header') }}</h1>
    <div class="subtitle">{{ __('emails.approved_subtitle') }}</div>
</div>
...
<div class="email-body">
    ...
    <div class="message">
        {{ __('emails.approved_message') }}
    </div>

    <div class="alert alert-success">
        <strong>{{ __('emails.approved_alert') }}</strong> {{ __('emails.approved_alert_text') }}
    </div>
