...
<head>
    <title>@yield('title', __('nav.dashboard')) - {{ __('nav.partner_area') }}</title>
    <meta charset="utf-8" />
            ...
            <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
                ...
                <div class="header-top-container container-xxl d-flex flex-grow-1 flex-stack">
                    ...
                    <div class="d-flex align-items-center me-5">
                        ...
                        <!--begin::Logo-->
                        <a href="{{ route('partner.dashboard') }}" class="d-flex align-items-center">
                            <img alt="MagShip" src="{{ asset('assets/media/logos/magship-logo.png') }}" class="h-35px rounded" style="padding: 4px; background: white;" />
                            <span class="badge badge-light-primary ms-3">{{ __('nav.partner_badge') }}</span>
                        </a>
                        <!--end::Logo-->
                    </div>
                    <!--end::Header Logo-->
                                ...
                                <div class="menu-item px-3">
                                    <div class="menu-content d-flex align-items-center px-3">
                                        <div class="symbol symbol-50px me-5 flex-shrink-0">
                                            <span class="symbol-label bg-light-success text-success fs-3 fw-bold">{{ auth()->user()->initials }}</span>
                                        </div>
                ...
                <div class="header-menu-container d-flex align-items-stretch flex-stack w-100" id="kt_header_nav">
                    <div class="header-menu container-xxl flex-column align-items-stretch flex-lg-row" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_header_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
                        ...
                        <div class="menu menu-column menu-lg-row menu-rounded menu-active-bg menu-title-gray-800 menu-state-primary menu-arrow-gray-500 fw-semibold my-5 my-lg-0 align-items-stretch flex-grow-1 px-2 px-lg-0" id="kt_header_menu" data-kt-menu="true">
                            ...
                            <div class="menu-item me-0 me-lg-2 {{ request()->routeIs('partner.dashboard') ? 'here show menu-here-bg' : '' }}">
                                <a class="menu-link py-3" href="{{ route('partner.dashboard') }}">
                            ...
                            <!--end::Menu item-->
                            <!--begin::Menu item - New Booking-->
                            <div class="menu-item me-0 me-lg-2 {{ request()->routeIs('partner.bookings.create') ? 'here show menu-here-bg' : '' }}">
                                <a class="menu-link py-3" href="{{ route('partner.bookings.create') }}">
                                    <span class="menu-icon">
                                    ...
                                    <span class="menu-title">{{ __('nav.new_booking') }}</span>
                                </a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item - My Bookings-->
                            <div class="menu-item me-0 me-lg-2 {{ request()->routeIs('partner.bookings.index') || request()->routeIs('partner.bookings.show') ? 'here show menu-here-bg' : '' }}">
                                <a class="menu-link py-3" href="{{ route('partner.bookings.index') }}">
                                    <span class="menu-icon">
                                    ...
                                    <span class="menu-title">{{ __('nav.my_bookings') }}</span>
                                </a>
                            </div>
                            <!--end::Menu item-->
                        </div>
                    ...
                    <div class="page-title d-flex flex-column">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 mb-1">
                            <li class="breadcrumb-item text-gray-700 fw-bold lh-1">
                                <a href="{{ route('partner.dashboard') }}" class="text-gray-600 text-hover-primary">
