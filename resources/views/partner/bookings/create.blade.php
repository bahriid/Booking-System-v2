...
@section('title', __('partner.new_booking'))
@section('page-title', __('partner.new_booking'))
...
<li class="breadcrumb-item">
    <a href="{{ route('partner.bookings.index') }}" class="text-muted text-hover-primary">{{ __('partner.bookings') }}</a>
</li>
<li class="breadcrumb-item">
    <i class="ki-duotone ki-right fs-7 text-gray-700 mx-n1"></i>
</li>
<li class="breadcrumb-item text-gray-500">{{ __('partner.new_booking') }}</li>
@endsection
...
<div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid gap-10" id="kt_create_booking_stepper">
            ...
            <div class="stepper-nav">
                ...
                <div class="stepper-item current" data-kt-stepper-element="nav">
                    <div class="stepper-wrapper">
                        ...
                        <div class="stepper-label">
                            <h3 class="stepper-title">{{ __('partner.select_tour') }}</h3>
                            <div class="stepper-desc fw-semibold">{{ __('partner.choose_your_tour') }}</div>
                        </div>
                    </div>
                ...
                <div class="stepper-item" data-kt-stepper-element="nav">
                    <div class="stepper-wrapper">
                        ...
                        <div class="stepper-label">
                            <h3 class="stepper-title">{{ __('partner.date_passengers') }}</h3>
                            <div class="stepper-desc fw-semibold">{{ __('partner.select_date_and_count') }}</div>
                        </div>
                    </div>
                    <div class="stepper-line h-40px"></div>
                </div>
                ...
                <div class="stepper-item" data-kt-stepper-element="nav">
                    <div class="stepper-wrapper">
                        ...
                        <div class="stepper-label">
                            <h3 class="stepper-title">{{ __('partner.passenger_details') }}</h3>
                            <div class="stepper-desc fw-semibold">{{ __('partner.enter_passenger_info') }}</div>
                        </div>
                    </div>
                    <div class="stepper-line h-40px"></div>
                </div>
                ...
                <div class="stepper-item" data-kt-stepper-element="nav">
                    <div class="stepper-wrapper">
                        ...
                        <div class="stepper-label">
                            <h3 class="stepper-title">{{ __('partner.review_submit') }}</h3>
                            <div class="stepper-desc fw-semibold">{{ __('partner.confirm_booking') }}</div>
                        </div>
                    </div>
                </div>
                <!--end::Step 4-->
    ...
    <div class="card d-flex flex-row-fluid flex-center">
        <form class="card-body py-20 w-100 mw-xl-700px px-9" id="kt_create_booking_form" method="POST" action="{{ route('partner.bookings.store') }}">
            <!--begin::Step 1-->
            <div class="current" data-kt-stepper-element="content">
                ...
                <div class="w-100">
                    <div class="pb-10 pb-lg-15">
                        <h2 class="fw-bold text-gray-900">{{ __('partner.select_tour') }}</h2>
                        <div class="text-muted fw-semibold fs-6">{{ __('partner.choose_tour_to_book') }}</div>
                    </div>
                    <div class="fv-row">
                        @if($tours->isEmpty())
                                        ...
                                        <label class="btn btn-outline btn-outline-dashed btn-active-light-{{ $color }} p-7 d-flex align-items-center h-100" for="tour_{{ $tour->id }}">
                                            ...
                                            <span class="d-block fw-semibold text-start">
                                                ...
                                                <span class="d-flex gap-2 mt-2">
                                                    <span class="badge badge-light-{{ $color }}">{{ __('partner.pax_max', ['count' => $tour->default_capacity]) }}</span>
                                                </span>
                                            </span>
                                        </label>
                                    </div>
            ...
            <div data-kt-stepper-element="content">
                <div class="w-100">
                    <div class="pb-10 pb-lg-12">
                        <h2 class="fw-bold text-gray-900">{{ __('partner.date_passengers') }}</h2>
                        <div class="text-muted fw-semibold fs-6">{{ __('partner.select_departure_date') }}</div>
                    </div>

                    <div class="fv-row mb-10">
                        <label class="form-label required">{{ __('partner.tour_date') }}</label>
                        <input type="text" class="form-control form-control-lg form-control-solid" id="tour_date" placeholder="{{ __('partner.select_date') }}" readonly />
                    </div>

                    <div class="fv-row mb-10" id="time-slots-container" style="display: none;">
                        <label class="d-flex align-items-center form-label mb-5">{{ __('partner.available_time_slots') }}</label>
                        <div class="row g-5" id="time-slots">
                            <!-- Populated by JavaScript -->
                        </div>
                        <div id="no-slots-message" class="alert alert-warning mt-3" style="display: none;">
                            {{ __('partner.no_departures_available') }}
                        </div>
                    </div>

                    <div class="row g-9 mb-8">
                        <div class="col-md-4 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">{{ __('partner.adults') }}</label>
                            <input type="number" class="form-control form-control-lg form-control-solid pax-input" id="adults" name="adults" value="1" min="0" max="20" />
                            <div class="form-text">{{ __('partner.years_12_plus') }}</div>
                        </div>
                        <div class="col-md-4 fv-row">
                            <label class="fs-6 fw-semibold mb-2">{{ __('partner.children') }}</label>
                            <input type="number" class="form-control form-control-lg form-control-solid pax-input" id="children_count" name="children_count" value="0" min="0" max="20" />
                            <div class="form-text">{{ __('partner.years_2_11') }}</div>
                        </div>
                        <div class="col-md-4 fv-row">
                            <label class="fs-6 fw-semibold mb-2">{{ __('partner.infants') }}</label>
                            <input type="number" class="form-control form-control-lg form-control-solid pax-input" id="infants" name="infants" value="0" min="0" max="10" />
                            <div class="form-text">{{ __('partner.years_0_1') }}</div>
                        </div>
                    </div>
                    ...
                    <div id="capacity-info" class="alert alert-info d-flex align-items-center p-5" style="display: none;">
                        ...
                        <div class="d-flex flex-column">
                            <span class="fw-bold">{{ __('partner.available_seats') }}: <span id="available-seats">-</span></span>
                            <span>{{ __('partner.selected_passengers') }}: <span id="total-pax">1</span></span>
                        </div>
                    </div>
                    ...
                    <div id="overbooking-warning" class="alert alert-warning d-flex align-items-center p-5" style="display: none;">
                        ...
                        <div class="d-flex flex-column">
                            <span class="fw-bold">{{ __('partner.overbooking_request') }}</span>
                            <span>{{ __('partner.overbooking_warning') }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div data-kt-stepper-element="content">
                <div class="w-100">
                    <div class="pb-10 pb-lg-12">
                        <h2 class="fw-bold text-gray-900">{{ __('partner.passenger_details') }}</h2>
                        <div class="text-muted fw-semibold fs-6">{{ __('partner.enter_details_each_passenger') }}</div>
                    </div>
            ...
            <div data-kt-stepper-element="content">
                <div class="w-100">
                    <div class="pb-8 pb-lg-10">
                        <h2 class="fw-bold text-gray-900">{{ __('partner.review_submit') }}</h2>
                        <div class="text-muted fw-semibold fs-6">{{ __('partner.review_before_submit') }}</div>
                    </div>

                    <div class="bg-light rounded p-8 mb-10">
                        <div class="row mb-5">
                            <div class="col-6">
                                <span class="text-muted d-block mb-1">{{ __('partner.tour') }}:</span>
                                <span class="fw-bold" id="review-tour">-</span>
                            </div>
                            <div class="col-6">
                                <span class="text-muted d-block mb-1">{{ __('partner.date_time') }}:</span>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <span class="text-muted d-block mb-1">{{ __('partner.passengers') }}:</span>
                                <span class="fw-bold" id="review-pax">-</span>
                            </div>
                            <div class="col-6">
                                <span class="text-muted d-block mb-1">{{ __('partner.status') }}:</span>
                    ...
                    <div id="review-overbooking-notice" class="notice d-flex bg-light-warning rounded border-warning border border-dashed p-4" style="display: none;">
                        ...
                        <div class="d-flex flex-stack flex-grow-1">
                            <div class="fw-semibold">
                                <div class="fs-6 text-gray-800 fw-bold">{{ __('partner.overbooking_request') }}</div>
                                <div class="fs-7 text-gray-700">{{ __('partner.overbooking_notice') }}</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="d-flex flex-stack pt-15">
                ...
                <div>
                    <button type="submit" class="btn btn-lg btn-primary" data-kt-stepper-action="submit">
                        <span class="indicator-label">{{ __('partner.submit_booking') }}
                            <i class="ki-duotone ki-arrow-right fs-4 ms-2">
                                <span class="path1"></span>
                                <span class="path2"></span>
                            </i>
                        </span>
                        <span class="indicator-progress">{{ __('partner.please_wait') }}
                            <span class="spinner-border spinner-border-sm align-middle ms-2"></span>
                        </span>
                    </button>
                    <button type="button" class="btn btn-lg btn-primary" data-kt-stepper-action="next">{{ __('partner.continue') }}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const departuresUrl = '{{ url("/partner/tours") }}';

    // Translations
    const trans = {
        cutoff: '{{ __('partner.cutoff') }}',
        seats: '{{ __('partner.seats') }}',
        full: '{{ __('partner.full') }}',
        errorLoadingDepartures: '{{ __('partner.error_loading_departures') }}',
        pleaseSelectTour: '{{ __('partner.please_select_tour') }}',
        pleaseSelectDateTime: '{{ __('partner.please_select_date_time') }}',
        atLeastOneAdult: '{{ __('partner.at_least_one_adult') }}',
        fillPassengerDetails: '{{ __('partner.fill_passenger_details') }}',
        selectPickupPoint: '{{ __('partner.select_pickup_point') }}',
        firstName: '{{ __('partner.first_name') }}',
        lastName: '{{ __('partner.last_name') }}',
        pickupPoint: '{{ __('partner.pickup_point') }}',
        phone: '{{ __('partner.phone') }}',
        allergies: '{{ __('partner.allergies') }}',
        notes: '{{ __('partner.notes') }}',
        adult: '{{ __('partner.adult') }}',
        child: '{{ __('partner.child') }}',
        infant: '{{ __('partner.infant') }}',
        passengers: '{{ __('partner.passengers') }}',
        pendingApproval: '{{ __('partner.pending_approval') }}',
        willBeConfirmed: '{{ __('partner.will_be_confirmed') }}',
    };
    ...
    stepper.on('kt.stepper.next', function(stepper) {
        ...
        // Special handling before step 3 (passenger details)
        if (currentStep === 2) {
            generatePassengerForms();
        }

        // Special handling before step 4 (review)
        if (currentStep === 3) {
            populateReview();
        }
    ...
    function loadDepartures(date) {
        ...
        // Reset previous time slot selection
        selectedDepartureId = null;
        selectedDeparture = null;
        tourDepartureInput.value = '';
        capacityInfo.style.display = 'none';
        overbookingWarning.style.display = 'none';
